...
const djlk003abExtension: BlockCategory = {
    id: 'djlk003ab',
    name: 'DJLK-003AB',
    blocks: [
        {
            id: 'djlk003ab-read',
            name: 'DJLK-003AB Read',
            color: COLOR,
            icon: '📡',
            category: 'DJLK-003AB',
            description: 'อ่านค่าระยะทาง (mm) จากเซ็นเซอร์อัลตราโซนิกกันน้ำ DJLK-003AB ผ่าน Modbus RTU\nต้องใช้ร่วมกับ ModbusMaster Extension',
            ...
            toCode({ pad, block, registerFunction, safeId, params }) {
                ...
                registerFunction(
                    `bool readDJLK003AB_id${device_id}(int *dist)`,
                    [
                        '  static int _dist = 0;',
                ...
                return {
                    parts: [
                        [`${pad}int ${id} = 0;`],
                        [`${pad}if (readDJLK003AB_id${device_id}(&${id})) {`],
...
export default djlk003abExtension;
